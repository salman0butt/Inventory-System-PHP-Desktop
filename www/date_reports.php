...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    $select=$pdo->prepare("select sum(total) as total , sum(subtotal) as stotal,count(invoice_id) as invoice from invoice where strftime('%d',order_date) = :date");
...
$invoice=$row->invoice;                    
          ...
          <table id="salesreporttable" class="table table-striped">
            ...
            <tbody>
              <?php
    $select=$pdo->prepare("select * from invoice where strftime('%d',order_date) = :date");
      $select->bindParam(':date',date('d',strtotime($_POST['date'])));  
             // $select->bindParam(':todate',$_POST['date_2']);
