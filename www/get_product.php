...
$imei_number = array();
try {
		$sql_query = "SELECT product_imei.* FROM `product_imei` LEFT OUTER JOIN `invoice_details` 
ON (product_imei.imei = invoice_details.product_imei ) WHERE product_imei.product_id=:product_id
 AND invoice_details.id is null";
